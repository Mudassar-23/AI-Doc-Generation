...
class AzureAIProvider(BaseProvider):
        ...
        if self.is_available():
            ...
            if RunnerConfig.SSL_CERT_FILE:
                ...
                http_client = httpx.Client(
                    verify=RunnerConfig.SSL_CERT_FILE,
    ...
    def fill_template(self, system_prompt: str, user_prompt: str) -> str:
        ...
        return self._call_llm(system_prompt, user_prompt, max_tokens=16000)
...
if __name__ == "__main__":
    ...
    print("Deployment:", provider.deployment_name)
    print("API Version:", provider.api_version)
